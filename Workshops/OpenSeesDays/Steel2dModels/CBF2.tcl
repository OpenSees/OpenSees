...
for {set story 1} {$story <= $numStory} {incr story 1} {
    ...
    HSSbrace $colLine1$floor1$colLine3$floor2 $colLine1$floor1 $colLine3$floor2 $theSection 3 4 $imperfection 3 
    HSSbrace $colLine3$floor1$colLine1$floor2 $colLine3$floor1 $colLine1$floor2 $theSection 3 4 $imperfection 3 
}
