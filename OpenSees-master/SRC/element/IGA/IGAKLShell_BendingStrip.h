...
#ifndef IGAKLShell_BendingStrip_h
#define IGAKLShell_BendingStrip_h
...
class IGAKLShell_BendingStrip : public Element {

public:

    //null constructor
    IGAKLShell_BendingStrip( );

    //full constructor
    IGAKLShell_BendingStrip( int tag,
    ...
    //destructor
    virtual ~IGAKLShell_BendingStrip( ) ;
