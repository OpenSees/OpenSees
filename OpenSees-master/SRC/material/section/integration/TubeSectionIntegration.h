...
// $Source: /usr/local/cvs/OpenSees/SRC/material/section/integration/TubeSectionIntegration.h,v $

#ifndef TubeSectionIntegration_h
#define TubeSectionIntegration_h
...
class TubeSectionIntegration : public SectionIntegration
{
 public:
  TubeSectionIntegration(double DIAM, double T, int NW, int NR);
