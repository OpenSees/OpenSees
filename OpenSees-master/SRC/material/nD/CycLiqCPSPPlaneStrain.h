...
// $Revision: 1 $
// $Date: 2012-09-01 $
// $Source: /usr/local/cvs/OpenSees/SRC/material/nD/soil/CycLiqCPSPPlaneStrain.h,v $
...
#ifndef CycLiqCPSPPlaneStrain_h
#define CycLiqCPSPPlaneStrain_h
...
class CycLiqCPSPPlaneStrain : public CycLiqCPSP {
...
//-------------------Declarations-------------------------------
  ...
  //null constructor
 CycLiqCPSPPlaneStrain() ;

  //full constructor
  CycLiqCPSPPlaneStrain(    int    tag,
	           double G01,
	           double kappa1,
	           double h1,
  ...
  const char *getClassType(void) const {return "CycLiqCPSPPlaneStrain";};
...
} ; //end of CycLiqCPSPPlaneStrain declarations
