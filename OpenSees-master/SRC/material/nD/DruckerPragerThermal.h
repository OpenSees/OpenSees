...
#ifndef DruckerPragerThermal_h
#define DruckerPragerThermal_h

// $Revision: 1.1 $
// $Date: 2010-02-04 00:44:04 $
// $Source: /usr/local/cvs/OpenSees/SRC/material/nD/DruckerPragerThermal.h,v $
...
class DruckerPragerThermal : public NDMaterial
{
 ...
 protected:
  ...
  Vector mSigma;
  Vector TempAndElong;  //TempAndElong, Liming, UoE2015
