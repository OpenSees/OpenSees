...
class BraceMaterial : public UniaxialMaterial
{
 public:
  BraceMaterial(int tag,
  ...
  const char *getClassType(void) const {return "BraceMaterial";};
 ...
 private:
  ...
  double TmomNu, CmomNu;
  double TmomPu, CmomPu;
  double Tidtime1, Cidtime1;
  double Tidtime, Cidtime;
