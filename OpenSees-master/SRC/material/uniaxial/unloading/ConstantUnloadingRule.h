...
#ifndef ConstantUnloadingRule_h
#define ConstantUnloadingRule_h

#include <UnloadingRule.h>

class ConstantUnloadingRule : public UnloadingRule
{
 public:
  ConstantUnloadingRule(int tag, double a = 0.0, double b = 1.0);
  ConstantUnloadingRule();
  virtual ~ConstantUnloadingRule();
