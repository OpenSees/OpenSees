...
// $Source: /usr/local/cvs/OpenSees/PACKAGES/NewElement/MyTrussPackage.cpp,v $
...
extern TclModelBuilder *theTclBuilder;
...
Mytruss_Init(Tcl_Interp *interp)
{
    ...
    Tcl_CreateCommand(interp, "myTruss", OpenSees_MyTruss,
