...
class ShellNLDKGTThermal : public Element {
 ...
 public:
  ...
  //destructor 
  virtual ~ShellNLDKGTThermal( ) ;

  const char *getClassType(void) const {return "ShellNLDKGTThermal";}
...
//end Yuli Huang (yulihuang@gmail.com) & Xinzheng Lu (luxz@tsinghua.edu.cn)
    ...
    double shapefn2d(double ss, double tt, int i);//added by LMJ,UoE
    ...
    double* dataMix; //LMJ
    int counterTemperature;//LMJ
    double residThermal[6];//LMJ
} ; 
