...
// Revision: A
//
// Description: This file contains the class definition for GMG_CMAZ2D.
// A GMG_CMAZ2D element is defined by two nodes with the same coordinate.
// The element only works with GMG_CMAC2D material model.
// It provides a force displacement relationship in 2D.
// The element is a modified version of the Zero-length element
...
class GMG_CMAZ2D : public Element
{
public:
	...
	const char *getClassType(void) const { return "GMG_CMAZ2D"; };
...
private:
	...
	Vector computeCurrentStrain1d(int mat, const Vector& diff) const;
