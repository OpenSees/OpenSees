...
// $Source: /usr/local/cvs/OpenSees/SRC/element/dispBeamColumn/DispBeamColumnWarping3d.h,v $

// Written: MHS
// Created: Feb 2001
//
// Description: This file contains the class definition for DispBeamColumnWarping3d.
...
class DispBeamColumnWarping3d : public Element
{
  public:
    DispBeamColumnWarping3d(int tag, int nd1, int nd2,
