...
#ifndef E_SFI_MVLEM_3D_h
#define E_SFI_MVLEM_3D_h
#include <Element.h>
#include <Matrix.h>
#include <Vector.h>
#include <ID.h>
...
class E_SFI_MVLEM_3D : public Element
{
public:

	// Constructors
	E_SFI_MVLEM_3D(int tag,						// element tag
		double Dens,							// density
...
private:
	...
	double h;							// height of E_SFI_MVLEM_3D element (undeformed configuration)
	double Lw;							// length of E_SFI_MVLEM_3D elemtn, i.e. wall length 
	...
	double *E_SFI_MVLEM_3DStrainX;		// macro-fiber axial strain in X direction (epsX)
	double *E_SFI_MVLEM_3DStrainY;		// macro-fiber axial strain in Y direction (epsY)
	double *E_SFI_MVLEM_3DStrainXY;		// macro-fiber shear strain (gammaXY)
	double *E_SFI_MVLEM_3DStrain;		// macro-fiber strains 
	double *Dens;						// macro-fiber densities
	double* rhox;						// macro-fiber rhox (for epsX expression)
	double* fyx;						// macro-fiber fyx (for epsX expression)
	double* fpc;						// macro-fiber fpc (for epsX expression)
	...
	Matrix E_SFI_MVLEM_3DK;		// stiffness
	Matrix E_SFI_MVLEM_3DD;		// damping
	Matrix E_SFI_MVLEM_3DM;		// mass 
	Vector E_SFI_MVLEM_3DR;		// force

	Matrix E_SFI_MVLEM_3DKlocal;	// Local stiffness matrix
	Vector E_SFI_MVLEM_3DRlocal;	// Local force vector
	Matrix E_SFI_MVLEM_3DMlocal;	// Local mass matrix
	Matrix E_SFI_MVLEM_3DDlocal;	// Local damping matrix
