...
EightNodeQuad::getResponse(int responseID, Information &eleInfo)
{
  if (responseID == 1) {
	...
	double We[8][9] = {{2.0758287072798374, 0.1666666666666666, -0.075828707279838,  0.1666666666666666, -0.7636648162452683, 0.0969981495786018, 0.0969981495786018, -0.7636648162452683, 0.0},
