...
extern void *OPS_zeroLengthInterface2DUpdate(void);
			      ...
			      Domain *theTclDomain, TclModelBuilder *theTclBuilder)
{
  ...
  } else if (strcmp(argv[1], "zeroLengthInterface2DUpdate") == 0) {
      Element* theEle = (Element*)OPS_zeroLengthInterface2DUpdate();
      if (theEle != 0)
          theElement = theEle;
      else {
          opserr << "TclElementCommand -- unable to create element of type : " << argv[1] << endln;
