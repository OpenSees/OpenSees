...
public:
    ...
    void setMeshTol(double tol) {meshtol = tol;}
    ...
    int addFixed(const VInt& ndtags);
    int addStructure();
    int gridNodes();
    int gridFluid();
    ...
    int preNForTri(double x1, double y1, double x2, double y2,
		   double x3, double y3, VDouble& coeff);
    void getNForTri(const VDouble& coeff, double x, double y,
		    VDouble& N);
    void getNForRect(double x0, double y0, double hx, double hy,
		     double x, double y, VDouble& N);
    
    int preNForTet(const VDouble& crds1, const VDouble& crds2,
		   const VDouble& crds3, const VDouble& crds4,
		   VVDouble& coeff);
    void getNForTet(const VVDouble& coeff, const VDouble& crds,
		    VDouble& N);
    void getNForRect(double x0, double y0, double z0,
    ...
    int solveLine(const VDouble& p1, const VDouble& dir,
