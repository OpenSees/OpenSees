...
// Modified: Hyun-myung Kim (hkim59@buffalo.edu) and Michael C. Constantinou (constan1@buffalo.edu)
...
void *OPS_LeadRubberX2()
{
    ...
    if (numMyBearing == 0) {
        opserr << "LeadRubberX2 element - Modified by Hyun-myung Kim and Michael C. Constantinou, University at Buffalo, 2020\n";
        numMyBearing++;
    }
