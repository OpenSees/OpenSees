...
//
// Four node PML2D_12 element Derivation based on the Adriano Torino PhD thesis
...
#define PML2D_12_NUM_DOF   20
#define PML2D_12_NUM_NODES 5
#define PML2D_12_NUM_PROPS 11
...
class PML2D_12 : public Element {

public:
	PML2D_12();                                                                       //null constructor
	PML2D_12(int tag, int *nodeTags, double *eleData);
	virtual ~PML2D_12();                                                              //destructor
	const char* getClassType(void) const { return "PML2D_12"; };                      //return class type
...
private:
    double props[PML2D_12_NUM_PROPS];
	ID connectedExternalNodes;  					//five node numbers
	Node* nodePointers[PML2D_12_NUM_NODES];    	    //pointers to five nodes
	double K[PML2D_12_NUM_DOF * PML2D_12_NUM_DOF];        // stiffness matrix
	double C[PML2D_12_NUM_DOF * PML2D_12_NUM_DOF];        // damping matrix
	double M[PML2D_12_NUM_DOF * PML2D_12_NUM_DOF];        // mass matrix
