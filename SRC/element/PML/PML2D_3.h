...
//
// Four node PML2D_3 element Derivation based on the Adriano Torino PhD thesis
...
#define PML2D_3_NUM_DOF   11
#define PML2D_3_NUM_NODES 5
#define PML2D_3_NUM_PROPS 8

class PML2D_3 : public Element {

public:
	PML2D_3();                                                                       //null constructor
	PML2D_3(int tag, int* nodeTags, double E, double nu,
...
private:
	...
	Node* nodePointers[PML2D_3_NUM_NODES];    	    //pointers to five nodes
	double K[PML2D_3_NUM_DOF * PML2D_3_NUM_DOF];        // stiffness matrix
	double C[PML2D_3_NUM_DOF * PML2D_3_NUM_DOF];        // damping matrix
	double M[PML2D_3_NUM_DOF * PML2D_3_NUM_DOF];        // mass matrix
