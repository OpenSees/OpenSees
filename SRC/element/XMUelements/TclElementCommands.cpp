...
extern  void *OPS_AddmassBeam(void);
...
TclModelBuilder_addAC3D8Hex(ClientData clientData, Tcl_Interp *interp, 
  ...
  int argc, TCL_Char **argv, Domain*, TclModelBuilder *, int argStart);
			      ...
			      Domain *theTclDomain, TclModelBuilder *theTclBuilder)
{
  ...
  else if ((strcmp(argv[1],"AddmassBeam") == 0) || (strcmp(argv[1],"addmassBeam") == 0)) {  
    
    void *theEle = OPS_AddmassBeam();
    if (theEle != 0) 
      theElement = (Element *)theEle;
    else {
      opserr << "tclelementcommand -- unable to create element of type : " << argv[1] << endln;
...
//------------------------------------------
  ...
  else if(_strcmpi(argv[1], "AC3D8") == 0) {

    return TclModelBuilder_addAC3D8Hex(clientData, interp, argc, 

      argv, theTclDomain, theTclBuilder, 1);

  }

    else if(_strcmpi(argv[1], "AC3D8WithSensitivity") == 0) {
  ...
  else if(_strcmpi(argv[1], "ASI3D8") == 0) {

    return TclModelBuilder_addASI3D8Quad(clientData, interp, argc, 

      argv, theTclDomain, theTclBuilder, 1);

  } 
    else if(_strcmpi(argv[1], "ASI3D8WithSensitivity") == 0) {
...
else if(_strcmpi(argv[1], "AV3D4") == 0) {
    return TclModelBuilder_addAV3D4Quad(clientData, interp, argc, 
      argv, theTclDomain, theTclBuilder, 1);
  }
   
else if(_strcmpi(argv[1], "AV3D4WithSensitivity") == 0) {
  ...
  else if(_strcmpi(argv[1], "VS3D4") == 0) {
    return TclModelBuilder_addVS3D4Quad(clientData, interp, argc, 
      argv, theTclDomain, theTclBuilder, 1);
  }
else if(_strcmpi(argv[1], "VS3D4WithSensitivity") == 0) {
...
//------------------------------------------
    ...
    int result = TclModelBuilder_addAC3D8(clientData, interp, argc, argv,
						theTclDomain, theTclBuilder);
    return result;
...
//------------------------------------------
  ...
  else if (strcmp(argv[1],"AC3D8Hex") == 0) {
    int eleArgStart = 1;
    int result = TclModelBuilder_addAC3D8Hex(clientData, interp, argc, argv,
					  theTclDomain, theTclBuilder, eleArgStart);
    return result;
  }

  else if (strcmp(argv[1],"AC3D8HexWithSensitivity") == 0) {
    int eleArgStart = 1;
    int result = TclModelBuilder_addAC3D8Hex(clientData, interp, argc, argv,
					  theTclDomain, theTclBuilder, eleArgStart);
    return result;
    ...
    else if (strcmp(argv[1],"ASI3D8Quad") == 0) {
    int eleArgStart = 1;
    int result = TclModelBuilder_addASI3D8Quad(clientData, interp, argc, argv,
					  theTclDomain, theTclBuilder, eleArgStart);
    return result;
  }

  else if (strcmp(argv[1],"ASI3D8QuadWithSensitivity") == 0) {
    int eleArgStart = 1;
    int result = TclModelBuilder_addASI3D8Quad(clientData, interp, argc, argv,
					  theTclDomain, theTclBuilder, eleArgStart);
    return result;
  }
  else if (strcmp(argv[1],"AV3D4Quad") == 0) {
    int eleArgStart = 1;
    int result = TclModelBuilder_addAV3D4Quad(clientData, interp, argc, argv,
					  theTclDomain, theTclBuilder, eleArgStart);
    return result;
  }
  else if (strcmp(argv[1],"AV3D4QuadWithSensitivity") == 0) {
    int eleArgStart = 1;
    int result = TclModelBuilder_addAV3D4Quad(clientData, interp, argc, argv,
					  theTclDomain, theTclBuilder, eleArgStart);
    return result;
  ...
  else if (strcmp(argv[1],"VS3D4Quad") == 0) {
    int eleArgStart = 1;
    int result = TclModelBuilder_addAV3D4Quad(clientData, interp, argc, argv,
					  theTclDomain, theTclBuilder, eleArgStart);
    return result;
  }
  else if (strcmp(argv[1],"VS3D4QuadWithSensitivity") == 0) {
    int eleArgStart = 1;
    int result = TclModelBuilder_addAV3D4Quad(clientData, interp, argc, argv,
					  theTclDomain, theTclBuilder, eleArgStart);
    return result;
