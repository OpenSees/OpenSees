...
// $Source: /usr/local/cvs/OpenSees/SRC/element/forceBeamColumn/ForceBeamColumn2dThermal.h,v $
...
class ForceBeamColumn2dThermal: public Element
{
 public:
  ForceBeamColumn2dThermal();
  ForceBeamColumn2dThermal(int tag, int nodeI, int nodeJ, 
  ...
  const char *getClassType(void) const {return "ForceBeamColumn2dThermal";};
