...
TclPackageClassBroker::getNewElement(int classTag)
{
  ...
  case ELE_TAG_ShellDKGQ: // Added by Lisha Wang, Xinzheng Lu, Linlin Xie, Song
                          // Cen & Quan Gu
    return new ShellDKGQ(); // Added by Lisha Wang, Xinzheng Lu, Linlin Xie,
                            // Song Cen & Quan Gu

  case ELE_TAG_ShellNLDKGQ: // Added by Lisha Wang, Xinzheng Lu, Linlin Xie,
                            // Song Cen & Quan Gu
    return new ShellNLDKGQ(); // Added by Lisha Wang, Xinzheng Lu, Linlin Xie,
                              // Song Cen & Quan Gu
