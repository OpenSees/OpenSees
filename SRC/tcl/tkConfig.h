...
// $Source: /usr/local/cvs/OpenSees/SRC/tcl/tkConfig.h,v $
 ...
 *
 * $Header: /usr/local/cvs/OpenSees/SRC/tcl/tkConfig.h,v 1.1.1.1 2000-09-15 08:23:24 fmk Exp $ SPRITE (Berkeley)
 */
