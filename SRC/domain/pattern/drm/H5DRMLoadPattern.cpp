...
bool H5DRMLoadPattern::CalculateBoundaryForces(double currentTime)
{
    ...
    constexpr int DegreesOfFreedom = 3;
    constexpr int MaxNodes = 8;
    
    static Vector Peff_b(MaxNodes * DegreesOfFreedom); 
    Peff_b.Zero();
    static Vector Peff_e(MaxNodes * DegreesOfFreedom); 
    Peff_e.Zero();
    
    static Vector u_b(MaxNodes * DegreesOfFreedom); 
    u_b.Zero();
    static Vector a_b(MaxNodes * DegreesOfFreedom); 
    a_b.Zero();
    static Vector u_e(MaxNodes * DegreesOfFreedom); 
    u_e.Zero();
    static Vector a_e(MaxNodes * DegreesOfFreedom); 
    a_e.Zero();

    static Matrix M_be(MaxNodes * DegreesOfFreedom, MaxNodes * DegreesOfFreedom); 
    M_be.Zero();
    static Matrix K_be(MaxNodes * DegreesOfFreedom, MaxNodes * DegreesOfFreedom); 
    K_be.Zero();
