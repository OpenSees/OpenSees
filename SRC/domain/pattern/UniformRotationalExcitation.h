...
// $Source: /usr/local/cvs/OpenSees/SRC/domain/pattern/UniformRotationalExcitation.h,v $
...
// UniformRotationalExcitation is a concrete class. It sets the R for a single
// ground motion acting on a structure.

#ifndef UniformRotationalExcitation_h
#define UniformRotationalExcitation_h

#include <EarthquakePattern.h>

class UniformRotationalExcitation : public EarthquakePattern
{
  public:
    UniformRotationalExcitation();  
    UniformRotationalExcitation(GroundMotion &theMotion, 
