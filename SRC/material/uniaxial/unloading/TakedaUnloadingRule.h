...
#ifndef TakedaUnloadingRule_h
#define TakedaUnloadingRule_h

#include <UnloadingRule.h>

class TakedaUnloadingRule : public UnloadingRule
{
 public:
  TakedaUnloadingRule(int tag, double c, double b);    
  TakedaUnloadingRule();
  virtual ~TakedaUnloadingRule();
