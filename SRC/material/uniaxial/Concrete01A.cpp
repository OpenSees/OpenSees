...
void * OPS_ADD_RUNTIME_VPV(OPS_NewConcrete01A)
{
  ...
  theMaterial = new Concrete01A(iData[0], dData[0], dData[1], dData[2], dData[3]);
...
Concrete01A::Concrete01A(int tag, double FPC, double EPSC0, double FPCU, double EPSCU)
...
int Concrete01A::setTrialStrain (double strain, double strainRate)
{
   /*
...
int 
Concrete01A::setTrial (double strain, double &stress, double &tangent, double strainRate)
{
	 // Reset trial history variables to last committed state
  /*
   TminStrain = CminStrain;
...
int
Concrete01A::commitSensitivity(double TstrainSensitivity, int gradIndex, int numGrads)
{
