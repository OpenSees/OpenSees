...
#ifndef Steel02_CDM_h
#define Steel02_CDM_h

#include <UniaxialMaterial.h>

class Steel02_CDM : public UniaxialMaterial
{
  public:
    Steel02_CDM(int tag,
    ...
    Steel02_CDM(int tag, double fy, double E0, double b);
	    
    Steel02_CDM(void);
    virtual ~Steel02_CDM();
    

    const char *getClassType(void) const {return "Steel02_CDM";};
