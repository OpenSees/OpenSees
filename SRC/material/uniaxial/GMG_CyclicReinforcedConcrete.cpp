...
GMG_CyclicReinforcedConcrete::sendSelf(int cTag, Channel &theChannel)
{
	...
	// Cyclic Properties
	data(209) = alpha_Er_Post_Yielding;
	data(210) = beta_Er_Post_Yielding;
	data(211) = alpha_Er_Post_Capping;
	data(212) = beta_Er_Post_Capping;

	data(15) = Er_Post_Yielding;
	data(16) = Er_Post_Capping;
	data(17) = Kun_Post_Yielding;
	data(18) = Kun_Post_Capping;
	data(19) = Kr_Post_Yielding;
	data(20) = Kr_Post_Capping;
	// Damage Properties
	data(21) = C1;
	data(22) = C2;
	data(23) = C3;
	data(24) = solpe_post_capping;
	data(144) = delta_ratio_max_hard;
	data(145) = Ref_Energy_Coe;
	data(148) = solpe_post_yielding;
	...
	data(49) = Cffmin_inner;
	data(50) = Cffmax_inner;
	data(51) = Cdpeakmax_inner;
	data(52) = Cdpeakmax_inner_inner;
	data(53) = Cffmax_inner_inner;
	data(54) = Cdpeakmin_inner_inner;
	data(55) = Cffmin_inner_inner;
	data(56) = CfouterNP_max;
	data(57) = CfouterPN_min;
	data(58) = CInCycFac_6;
	data(59) = CInCycFac_7;
	data(60) = CInCycFac_neg_6;
	data(61) = CInCycFac_neg_7;

	data(62) = CBenchmark56_down;
	data(158) = Benchmark56_down;
	data(159) = CBenchmark56_up;
	data(160) = CBenchmark56_up;

	data(63) = CBenchmark_neg_56_up;
	data(161) = Benchmark_neg_56_up;
	data(162) = CBenchmark_neg_56_down;
	data(163) = Benchmark_neg_56_down;

	data(64) = CBenchmark67_up;
	data(65) = CBenchmark67_down;
	data(66) = CBenchmark_neg_67_up;
	data(67) = CBenchmark_neg_67_down;
	data(68) = Cspos_pos;
	data(69) = Csneg_pos;
	data(70) = CEt_pos;
	data(71) = CEc_pos;
	...
	data(77) = CEneg_neg;
	data(78) = CT_area;
	data(80) = Cflagdmg_Hardening;
	data(81) = flagdmg_Hardening;
	data(82) = alpha;
	data(83) = Calpha;
	data(84) = Intcpt_res_pos;
	data(85) = CIntcpt_res_pos;
	data(86) = Intcpt_res_neg;
	data(87) = CIntcpt_res_neg;
	...
	data(94) = Ec_hard;
	data(95) = CEc_hard;
	data(96) = spos_pos_hard;
	data(97) = Cspos_pos_hard;
	data(98) = sneg_pos_hard;
	data(99) = Csneg_pos_hard;
	data(100) = Et_pos_hard;
	data(101) = CEt_pos_hard;
	data(102) = Ec_pos_hard;
	data(103) = CEc_pos_hard;
	data(104) = spos_neg_hard;
	data(105) = Cspos_neg_hard;
	data(106) = sneg_neg_hard;
	data(107) = Csneg_neg_hard;
	data(108) = Et_neg_hard;
	data(109) = CEt_neg_hard;
	data(110) = Ec_neg_hard;
	data(111) = CEc_neg_hard;
	data(112) = Epos_pos_hard;
	data(113) = CEpos_pos_hard;
	data(114) = Eneg_neg_hard;
	data(115) = CEneg_neg_hard;
	data(116) = CEpos_hard;
	data(117) = Epos_hard;
	data(118) = CEneg_hard;
	data(119) = Epos_hard;
	...
	data(122) = CEneg;
	data(123) = Eneg;
	data(124) = CEposnorm_hard;
	data(125) = Eposnorm_hard;
	data(126) = CEnegnorm_hard;
	data(127) = Enegnorm_hard;
	data(128) = Cdelta_pos_hard;
	data(129) = delta_pos_hard;
	data(132) = Cdelta_neg_hard;
	data(133) = delta_neg_hard;

	data(136) = Calpha_pos;
	data(137) = alpha_pos;
	data(138) = Calpha_neg;
	data(139) = alpha_neg;
	data(140) = Cdpealmax_bench;
	data(141) = dpealmax_bench;
	data(142) = Cdpeakmin_bench;
	data(143) = dpeakmin_bench;
	data(146) = Cflagdmg_Hardening_strength;
	data(147) = flagdmg_Hardening_strength;
	data(148) = Intcpt_deg_neg;
	data(149) = CIntcpt_deg_neg;
	data(150) = Intcpt_Xaxis_pos;
	data(151) = CIntcpt_Xaxis_pos;
	data(152) = Intcpt_Xaxis_neg;
	data(153) = CIntcpt_Xaxis_neg;
	data(154) = Ed0pos_hard;
	data(155) = Ed1pos_hard;
	data(156) = Ed0neg_hard;
	data(157) = Ed1neg_hard;
	data(164) = R_dypos;
	data(165) = R_fypos;
	data(166) = R_Kdegpos;
	data(167) = R_fyneg;
	...
	FEM_ObjectBroker &theBroker)
{
	...
	if (res < 0) {
		...
		// Cyclic Properties
		alpha_Er_Post_Yielding = data(209);
		beta_Er_Post_Yielding = data(210);
		alpha_Er_Post_Capping = data(211);
		beta_Er_Post_Capping = data(212);
		Er_Post_Yielding = data(15);
		Er_Post_Capping = data(16);
		Kun_Post_Yielding = data(17);
		Kun_Post_Capping = data(18);
		Kr_Post_Yielding = data(19);
		Kr_Post_Capping = data(20);

		// Damage Properties
		C1 = data(21);
		C2 = data(22);
		C3 = data(23);
		solpe_post_capping = data(24);
		delta_ratio_max_hard = data(144);
		Ref_Energy_Coe = data(145);
		solpe_post_yielding = data(148);
		...
		Cffmin_inner = data(49);
		Cffmax_inner = data(50);
		Cdpeakmax_inner = data(51);
		Cdpeakmax_inner_inner = data(52);
		Cffmax_inner_inner = data(53);
		Cdpeakmin_inner_inner = data(54);
		Cffmin_inner_inner = data(55);
		CfouterNP_max = data(56);
		CfouterPN_min = data(57);

		CInCycFac_6 = data(58);
		CInCycFac_7 = data(59);
		CInCycFac_neg_6 = data(60);
		CInCycFac_neg_7 = data(61);

		CBenchmark56_down = data(62);
		Benchmark56_down = data(158);
		CBenchmark56_up = data(159);
		Benchmark56_up = data(160);

		CBenchmark_neg_56_up = data(63);
		Benchmark_neg_56_up = data(161);
		CBenchmark_neg_56_down = data(162);
		Benchmark_neg_56_down = data(163);
		CBenchmark67_up = data(64);
		CBenchmark67_down = data(65);
		CBenchmark_neg_67_up = data(66);
		CBenchmark_neg_67_down = data(67);
		Cspos_pos = data(68);
		Csneg_pos = data(69);
		CEt_pos = data(70);
		CEc_pos = data(71);
		...
		CEneg_neg = data(77);
		CT_area = data(78);
		Cflagdmg_Hardening = data(80);
		flagdmg_Hardening = data(81);
		alpha = data(82);
		Calpha = data(83);
		Intcpt_res_pos = data(84);
		CIntcpt_res_pos = data(85);
		Intcpt_res_neg = data(86);
		CIntcpt_res_neg = data(87);
		...
		Ec_hard = data(94);
		CEc_hard = data(95);
		spos_pos_hard = data(96);
		Cspos_pos_hard = data(97);
		sneg_pos_hard = data(98);
		Csneg_pos_hard = data(99);
		Et_pos_hard = data(100);
		CEt_pos_hard = data(101);
		Ec_pos_hard = data(102);
		CEc_pos_hard = data(103);
		spos_neg_hard = data(104);
		Cspos_neg_hard = data(105);
		sneg_neg_hard = data(106);
		Csneg_neg_hard = data(107);
		Et_neg_hard = data(108);
		CEt_neg_hard = data(109);
		Ec_neg_hard = data(110);
		CEc_neg_hard = data(111);
		Epos_pos_hard = data(112);
		CEpos_pos_hard = data(113);
		Eneg_neg_hard = data(114);
		CEneg_neg_hard = data(115);
		CEpos_hard = data(116);
		Epos_hard = data(117);
		CEneg_hard = data(118);
		Epos_hard = data(119);
		...
		CEneg = data(122);
		Eneg = data(123);
		CEposnorm_hard = data(124);
		Eposnorm_hard = data(125);
		CEnegnorm_hard = data(126);
		Enegnorm_hard = data(127);

		Cdelta_pos_hard = data(128);
		delta_pos_hard = data(129);
		Cdelta_neg_hard = data(132);
		delta_neg_hard = data(133);

		Calpha_pos = data(136);
		alpha_pos = data(137);
		Calpha_neg = data(138);
		alpha_neg = data(139);
		Cdpealmax_bench = data(140);
		dpealmax_bench = data(141);
		Cdpeakmin_bench = data(142);
		dpeakmin_bench = data(143);
		flagdmg_Hardening_strength = data(146);
		Cflagdmg_Hardening_strength = data(147);
		Intcpt_deg_neg = data(148);
		CIntcpt_deg_neg = data(149);
		Intcpt_Xaxis_pos = data(150);
		CIntcpt_Xaxis_pos = data(151);
		Intcpt_Xaxis_neg = data(152);
		CIntcpt_Xaxis_neg = data(153);
		Ed0pos_hard = data(154);
		Ed1pos_hard = data(155);
		Ed0neg_hard = data(156);
		Ed1neg_hard = data(157);
		R_dypos = data(164);
		R_fypos = data(165);
		R_Kdegpos = data(166);
		R_fyneg = data(167);
