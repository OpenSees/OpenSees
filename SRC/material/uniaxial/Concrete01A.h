...
#ifndef Concrete01A_h
#define Concrete01A_h
...
class Concrete01A : public UniaxialMaterial
{
 public:
  Concrete01A (int tag, double fpc, double eco, double fpcu, double ecu);
  Concrete01A ();
  ~Concrete01A();

  const char *getClassType(void) const {return "Concrete01A";};
