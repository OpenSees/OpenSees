...
Masonry::Masonry(int tag, double _Fm, double _Ft,
	...
	int _IENV) :
	UniaxialMaterial(tag, 0), Fm(_Fm), Ft(_Ft),
...
Masonry::Masonry(void) :
	UniaxialMaterial(0, 0), Fm(0), Ft(0), Um(0), Uult(0), Ucl(0), Emo(0), Length(0), Area1(0), Area2(0), D1(0),
...
void
Masonry::TRACCION(double Um, double &Upl, double Ft, double Emo, double &Et, double &S, double Uma, double U, double Ucl, double &UMAXIMA, int &INDIC)
{
