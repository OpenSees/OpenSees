...
// $Source: /usr/local/cvs/OpenSees/SRC/material/uniaxial/Concrete01T.h,v $
                                                                        
// Modified by Kristijan Kolozvari to include tension capacity up to cracking.
                                                                        
#ifndef Concrete01T_h
#define Concrete01T_h
...
// Concrete01T.h adapted from Concr1.f90 (Filippou)
//   - Modified Kent-Park envelope
//   - No tension
//   - Linear unloading/reloading
//
// What: "@(#) Concrete01T.h, revA"


#include <UniaxialMaterial.h>

class Concrete01T : public UniaxialMaterial
{
 public:
  Concrete01T (int tag, double fpc, double eco, double fpcu, double ecu);
  Concrete01T (int tag, double fpc, double eco, double fpcu, double ecu, double ft, double et);
  Concrete01T (int tag, double fpc, double eco, double fpcu, double ecu, double ft, double et, int mon);
  Concrete01T ();
  ~Concrete01T();

  const char *getClassType(void) const {return "Concrete01T";};
 ...
 private:
  ...
  double et; // Strain at cracking

  int mon; // Monotonic switch

  double Et; // tensile stiffness
  ...
  double Cracking; // keep crack of concrete cracking
