...
#ifndef PetrangeliStrengthDegradation_h
#define PetrangeliStrengthDegradation_h

#include <StrengthDegradation.h>

class PetrangeliStrengthDegradation : public StrengthDegradation
{
 public:
  PetrangeliStrengthDegradation(int tag, double e1, double V2, double e2);    
  PetrangeliStrengthDegradation();
  virtual ~PetrangeliStrengthDegradation();
