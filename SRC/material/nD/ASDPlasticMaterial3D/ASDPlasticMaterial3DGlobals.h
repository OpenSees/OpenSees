...
#ifndef ASDPlasticMaterial3DGlobals_H
#define ASDPlasticMaterial3DGlobals_H

#include "EigenAPI.h"
#include <limits>
#include <tuple>
#include <string>
namespace ASDPlasticMaterial3DGlobals
{
...
enum struct ASDPlasticMaterial3D_Constitutive_Integration_Method : int
{
    Not_Set,
    Forward_Euler,
...
void printTensor1(std::string const& name, VoigtVector const& v)
{
...
void printTensor2(std::string const& name, VoigtMatrix const& v)
{
    std::cout << name << " = [ " ;
