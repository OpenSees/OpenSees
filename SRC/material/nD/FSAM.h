...
public:
	...
	FSAM (int tag,              // nDMaterial tag
		...
		int CracBType);			// Crack B criteria type
	...
	const char *getType(void) const { return "FSAM";};
...
private:
	...
	void InterLocker_improved(double &e_cr_normal, double &f_cr_normal, double &e_cr_parallel, double &e_cr_parallel_old, double &epc, double &Ec, double &Tau_Interlock_old); // original shear aggregate interlock
	void InterLocker_LinearElastic(double &e_cr_parallel, double &Ec); // linear elastic shear aggregate interlock
	...
	int typeAggLock;				// optional, aggregate interlock type (default = 2)
	int typeCrackB;					// optional, CracbB criteria type (10: sigma1 > 0.0, 20: = eA1 > et, detfault = 10)
	...
	Vector TStrainStressConcA1;
	Vector TStrainStressConcA2;
	Vector TStrainStressConcB1;
	Vector TStrainStressConcB2;
	...
	Vector CStrainStressConcA1;
	Vector CStrainStressConcA2;
	Vector CStrainStressConcB1;
	Vector CStrainStressConcB2;
	Vector CStrainStressInterlock1; 
	Vector CStrainStressInterlock2;
	Vector CCrackingAngles;

	Vector cyclicCRstrain;
	...
	Vector getStrainStressConcreteA1(void);
	Vector getStrainStressConcreteA2(void);
	Vector getStrainStressConcreteB1(void);
	Vector getStrainStressConcreteB2(void);
	Vector getStrainStressInterlock1(void);
	Vector getStrainStressInterlock2(void);
	Vector getCrackingAngles(void);
	Vector getCyclicCrackingStrain(void);

	double getK0scaled(void);
