...
LinearHardeningTensor_EV::LinearHardeningTensor_EV( double H_) : EvolvingVariable(VoigtVector()), H(H_)
{}

LinearHardeningTensor_EV::LinearHardeningTensor_EV( double H_, const VoigtVector& alpha0) : EvolvingVariable(alpha0), H(H_)
{}
