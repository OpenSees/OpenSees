...
#include "DruckerPragerArmstrongFrederickLE.h"
...
DruckerPragerArmstrongFrederickLE::DruckerPragerArmstrongFrederickLE(int tag_in, double k0_in, double ha_alpha, double cr_alpha, double H_k, double E, double nu, double rho_, double p0) :
    DPAFLEBase::ASDPlasticMaterial(tag_in, rho_, p0,
            ...
            DPAFLEVarsType(alpha, k)),     // Declare the list of internal variables
...
DruckerPragerArmstrongFrederickLE::DruckerPragerArmstrongFrederickLE(int tag_in, double rho, double p0, DPAFLE_YFType &yf,
...
int DruckerPragerArmstrongFrederickLE::pre_integration_callback(const VoigtVector &depsilon,
...
void
DruckerPragerArmstrongFrederickLE::Print(ostream& s, int flag)
{
    s << "DruckerPragerArmstrongFrederickLE" << endln;
