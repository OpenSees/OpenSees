...
class HSSSectionIntegration : public SectionIntegration
{
 public:
  HSSSectionIntegration(double h, double b, double t,
			int Nfh, int Nfb, int Nft = 1);
  HSSSectionIntegration();
  ~HSSSectionIntegration();
  ...
  const char* getClassType(void) const {return "HSSSectionIntegration";}
