...
// $Source: /usr/local/cvs/OpenSees/SRC/material/section/fiber/newUniaxialFiber3d.h,v $
...
class UniaxialFiber3d: public UniaxialFiber
{
  public:
    ...
    Vector &getFiberStressResultants (void) const;
    Matrix &getFiberTangentStiffContr (void) const; 

    Matrix &getFiberSecantStiffContr (void) const; 
