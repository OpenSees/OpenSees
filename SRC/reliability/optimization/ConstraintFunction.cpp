...
# define CONSTRAINT_FUNCTION 1000  //should move to classTags.h
...
:ReliabilityDomainComponent(passedTag, CONSTRAINT_FUNCTION)
{
...
//	int numOfDV=theReliabilityDomain->getNumberOfDesignVariables();
	...
	int numOfDesignVariables = theReliabilityDomain->getNumberOfDesignVariables();
