...
int
GFunEvaluator::nodeParse(char *tempchar, int *node, int *dirn, char* disp, char* varName, char* arrName)
{
	// match regular expressions of known lsf parameters
...
int
GFunEvaluator::elementParse(char *tempchar, int *element, char* varName, char* eleArgs)
{
	int args = 0;
...
int
GFunEvaluator::nodeTclVariable(int nodeNumber, int direction, char* dispOrWhat, char* varName, char* arrName)
{
...
int
GFunEvaluator::elementTclVariable(int eleNumber, char* varName, char* inString)
{
