...
{
  public:
    LinearCrdTransf2d (int tag, const Vector &rigJntOffsetI, const Vector &rigJntOffsetJ, int PDeltaFlag = 0);
  ...
  private:
    ...
    static Vector ul;      // local displacements (needed fpr PDelta effects)
