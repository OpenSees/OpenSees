...
// $Source: /usr/local/cvs/OpenSees/SRC/system_of_eqn/linearSOE/sparseGEN/SuperLU_MT_pdsp_defs.h,v $
...
#ifndef __SUPERLU_MT_dSP_DEFS /* allow multiple inclusions */
#define __SUPERLU_MT_dSP_DEFS

#include "SuperLU_MT_pxgstrf_synch.h"
#include "SuperLU_MT_util.h"
#include <pthread.h>
