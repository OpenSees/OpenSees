...
DesignVariableIter::DesignVariableIter(TaggedObjectStorage *theStorage)
  :myIter(theStorage->getComponents())
{
}


DesignVariableIter::~DesignVariableIter()
{
}    

void
DesignVariableIter::reset(void)
{
    myIter.reset();
}    
...
DesignVariable *
DesignVariableIter::operator()(void)
{
