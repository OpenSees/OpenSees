...
** ****************************************************************** */
 ...
 // Created: 2019
 //
 // Description: This file contains the class definition for TDConcreteMC10NL. 
...
{
  public:
    TDConcreteMC10NL(int tag, double _fc, double _fcu, double _espcu, double _ft, double _Ec, double _Ecm, double _beta, double _age, double _epsba, double _epsbb, double _epsda, double _epsdb, double _tcr, double _phiba, double _phibb, double _phida, double _phidb, double _phidc, double _tcast);

    TDConcreteMC10NL(void);

    virtual ~TDConcreteMC10NL();

    const char *getClassType(void) const {return "TDConcreteMC10NL";};    
