...
** ****************************************************************** */
 ...
 // Created: 2012
 //
 // Description: This file contains the class definition for TDConcreteEXP. 
 ...
 ! Concrete Creep - Experimental Linear superposition of creep coefficient, ACI 209 time function
 ! Concrete Shrinkage - ACI 209 time function
 -------------------------------*/
 //
 // The framework for this code was originally modified from Concrete02.

#ifndef TDConcreteEXP_h
#define TDConcreteEXP_h

#include <UniaxialMaterial.h>
#include <Domain.h> //Added by AMK

class TDConcreteEXP : public UniaxialMaterial
{
  public:
    TDConcreteEXP(int tag, double _fc, double _ft, double _Ec, double _beta, double _age, double _epsshu, double _epssha, double _tcr, double _epscru, double _sigCr, double _epscra, double _epscrd, double _tcast);

    TDConcreteEXP(void);

    virtual ~TDConcreteEXP();

    const char *getClassType(void) const {return "TDConcreteEXP";};    
