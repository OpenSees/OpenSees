# 
# Template elasto-plastic material model for soft clay, Cam-Clay yield surface
# rho = 1.3 ton/m^3 
...
# EPState
#------------E--------Eo--------v----rho------------------po
set EPS " 36660.0  36660.0    0.406  1.3  -NOD 0 -Nos 1  200.1 -stressp $stressp"

# Create nDMaterial using Template Elastic-Plastic Model
nDMaterial Template3Dep 1300 -YS $DPys -PS $DPps -EPS $EPS -ELS1 $ES1
