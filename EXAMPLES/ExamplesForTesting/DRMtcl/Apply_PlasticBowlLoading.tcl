...
pattern PBowlLoading 1 -pbele "$Dir/PBElements.dat" -acce "../../ExampleScripts/DRMtcl/Inp_acce.dat" -disp "../../ExampleScripts/DRMtcl/Inp_disp.dat" -dt 0.02 -factor 1 -xp 6.0 -xm -6.0 -yp 6.0 -ym -6.0 -zp 0.0 -zm -17.5
