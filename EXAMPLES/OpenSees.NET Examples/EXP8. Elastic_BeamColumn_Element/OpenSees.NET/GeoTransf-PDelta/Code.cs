public static void Exp8_PDelta()
        {
            ...
            var Trans_tag = 1;
            var geotransf = new OpenSees.Elements.CrdTransfs.PDeltaCrdTransf3dWrapper(new OpenSees.VectorWrapper(new double[] { Vec_Z_x, Vec_Z_y, Vec_Z_z }));
