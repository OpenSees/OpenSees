public static void Exp6_BCF()
        {
            ...
            #region materials
            int rigidmattag = 1;//set rigidmattag						1
            int semi_rigidmattag = 101;//set semi_rigidmattag				101
            int Freemattag = 2;//set Freemattag						2
            int timbermattag_long = 30;//set timbermattag_long				30
            int timbermattag_trans = 31;//set timbermattag_trans				31
            int G_Timber_Tag_Long = 32;//set G_Timber_Tag_Long				32
            int G_Timber_Tag_Trans = 33;//set G_Timber_Tag_Trans				33
            int timbermattag_Ortho_Long = 21;//set timbermattag_Ortho_Long			21
            int timbermattag_Ortho_Trans = 22;//set timbermattag_Ortho_Trans		22
            int Stiffness_Tension = 10;//set Stiffness_Tension				10
            int Stiffness_IP = 11;//set Stiffness_IP					11
            int Stiffness_OOP = 12;//set Stiffness_OOP					12
            int Stiffness_about_Tension = 13;//set Stiffness_about_Tension			13
            int Stiffness_about_IP = 14;//set Stiffness_about_IP				14
            int Stiffness_about_OOP = 15;//set Stiffness_about_OOP				15
            int Trans_Shear_Timoshenko_Eq = 70;//set Trans_Shear_Timoshenko_Eq		70
            int Long_Shear_Timoshenko_Eq = 71;//set Long_Shear_Timoshenko_Eq		71
            int Long_Shear_Timoshenko_Parallel = 72;//set Long_Shear_Timoshenko_Parallel	72
            int Long_Shear_Timoshenko_Serial = 73;//set Long_Shear_Timoshenko_Serial	73
            ...
            // iman modifi var timbermattag_longMat = new OpenSees.Materials.Uniaxials.EPPGapMaterialWrapper(timbermattag_long, E_Timber_Long, 430.0, 20, 0, 0); //uniaxialMaterial 	ElasticPPGap $timbermattag_long $E_Timber_Long 430. 20.
            var timbermattag_longMat = new OpenSees.Materials.Uniaxials.ElasticMaterialWrapper(timbermattag_long, E_Timber_Long, 0); //uniaxialMaterial 	ElasticPPGap $timbermattag_long $E_Timber_Long 430. 20.
            var timbermattag_transMat = new OpenSees.Materials.Uniaxials.ElasticMultiLinearWrapper(timbermattag_trans, new OpenSees.VectorWrapper(new double[] { -100.0, -50.0, -20.0, 0.0, 5.0, 12.0, 47.0, 60.0, 120.0 }), new OpenSees.VectorWrapper(new double[] { -100.0, -50.0, -20.0, 0.0, 50.0, 120.0, 4700.0, 600.0, 120.0 }), 0);//uniaxialMaterial 	ElasticMultiLinear $timbermattag_trans -strain -100.	-50.	-20.	0.	5.	12.	47.	60.	120. -stress -100.	-50.	-20.	0.	50.	120.	4700.	600.	120.
            var G_Timber_Tag_LongMat = new OpenSees.Materials.Uniaxials.ElasticBilinWrapper(G_Timber_Tag_Long, 80.0, 10.0, 12.0, 50.0, 20.0, 9.0);//uniaxialMaterial 	ElasticBilin $G_Timber_Tag_Long 80. 10. 12.0 50. 20. 9.0
            ...
            var Trans_Shear_Timoshenko_EqMat = new OpenSees.Materials.Uniaxials.ElasticMaterialWrapper(Trans_Shear_Timoshenko_Eq, 34.878, 0);//uniaxialMaterial	Elastic	$Trans_Shear_Timoshenko_Eq	[expr 34.878]
            var Long_Shear_Timoshenko_EqMat = new OpenSees.Materials.Uniaxials.ElasticMaterialWrapper(Long_Shear_Timoshenko_Eq, 11.971, 0);//uniaxialMaterial	Elastic	$Long_Shear_Timoshenko_Eq	[expr 11.971]
            var Long_Shear_Timoshenko_ParallelMat = new OpenSees.Materials.Uniaxials.ParallelMaterialWrapper(Long_Shear_Timoshenko_Parallel, 2, new OpenSees.Materials.Uniaxials.UniaxialMaterialWrapper[] { Trans_Shear_Timoshenko_EqMat, Long_Shear_Timoshenko_EqMat }, new OpenSees.VectorWrapper(new double[] { 1, 1 }));//uniaxialMaterial Parallel $Long_Shear_Timoshenko_Parallel $Trans_Shear_Timoshenko_Eq $Long_Shear_Timoshenko_Eq
            var Long_Shear_Timoshenko_SerialMat = new OpenSees.Materials.Uniaxials.SeriesMaterialWrapper(Long_Shear_Timoshenko_Serial, 2, new OpenSees.Materials.Uniaxials.UniaxialMaterialWrapper[] { Trans_Shear_Timoshenko_EqMat, Trans_Shear_Timoshenko_EqMat }, 1, 1e-10); //uniaxialMaterial Series $Long_Shear_Timoshenko_Serial $Trans_Shear_Timoshenko_Eq $Trans_Shear_Timoshenko_Eq
            ...
            // GJ
            var gjmat = new OpenSees.Materials.Uniaxials.ElasticMaterialWrapper(1000, 12e6, 0);

            int width_Perimeter_long_right_tag = 1;//set width_Perimeter_long_right_tag	1
            var repres1 = new OpenSees.Materials.Sections.Repres.FiberSectionReprWrapper(1,
                new OpenSees.Materials.Sections.Repres.PatchWrapper[]
                {
                        new OpenSees.Materials.Sections.Repres.QuadPatchWrapper(timbermattag_long,20,5,new OpenSees.MatrixWrapper(new double[,]{
                            { -width_Perimeter_long_right/2.0, tickness / 2.0 },
                            { width_Perimeter_long_right/2.0, tickness/2.0 },
                            { width_Perimeter_long_right/2.0, -tickness/2.0 },
                            {-width_Perimeter_long_right/2.0, -tickness/2.0 }
                        })),
            ...
            var width_Perimeter_long_right_tagSec = new OpenSees.Materials.Sections.FiberSection3dWrapper(
                width_Perimeter_long_right_tag,
                repres1,
                new Dictionary<int, OpenSees.Materials.Uniaxials.UniaxialMaterialWrapper>() { { timbermattag_long, timbermattag_longMat } },
                gjmat);


            int width_Perimeter_long_left_tag = 2;//set width_Perimeter_long_left_tag	2
            var repres2 = new OpenSees.Materials.Sections.Repres.FiberSectionReprWrapper(1,
                new OpenSees.Materials.Sections.Repres.PatchWrapper[]
                {
                        new OpenSees.Materials.Sections.Repres.QuadPatchWrapper(G_Timber_Tag_Long,20,5,new OpenSees.MatrixWrapper(new double[,]{
                            { -width_Perimeter_long_left/2.0, tickness / 2.0 },
                            { width_Perimeter_long_left/2.0, tickness/2.0 },
                            { width_Perimeter_long_left/2.0, -tickness/2.0 },
                            { -width_Perimeter_long_left/2.0, -tickness/2.0 }
                        })),
            ...
            var width_Perimeter_long_left_tagSec = new OpenSees.Materials.Sections.FiberSection3dWrapper(
                width_Perimeter_long_left_tag,
                repres2,
                new Dictionary<int, OpenSees.Materials.Uniaxials.UniaxialMaterialWrapper>() { { G_Timber_Tag_Long, G_Timber_Tag_LongMat } },
                gjmat);



            int width_Perimeter_trans_up_tag = 3;//set width_Perimeter_trans_up_tag	3
            var repres3 = new OpenSees.Materials.Sections.Repres.FiberSectionReprWrapper(1,
                new OpenSees.Materials.Sections.Repres.PatchWrapper[]
                {
                        new OpenSees.Materials.Sections.Repres.QuadPatchWrapper(timbermattag_trans,5,20,new OpenSees.MatrixWrapper(new double[,]{
                            {-width_Perimeter_trans_up/2.0, -tickness/2.0 },
                            {-width_Perimeter_trans_up/2.0, tickness/2.0 },
                            { width_Perimeter_trans_up/2.0, tickness/2.0 },
                            { width_Perimeter_trans_up/2.0, -tickness/2.0 }
                        })),
            ...
            var width_Perimeter_trans_up_tagSec = new OpenSees.Materials.Sections.FiberSection3dWrapper(
                width_Perimeter_trans_up_tag,
                repres3,
                new Dictionary<int, OpenSees.Materials.Uniaxials.UniaxialMaterialWrapper>() { { timbermattag_trans, timbermattag_transMat } },
                gjmat);


            int width_Perimeter_trans_down_tag = 4;//set width_Perimeter_trans_down_tag	4
            var repres4 = new OpenSees.Materials.Sections.Repres.FiberSectionReprWrapper(1,
                new OpenSees.Materials.Sections.Repres.PatchWrapper[]
                {
                                    new OpenSees.Materials.Sections.Repres.QuadPatchWrapper(G_Timber_Tag_Trans,5,20,new OpenSees.MatrixWrapper(new double[,]{
                                        {-width_Perimeter_trans_down/2.0, -tickness/2.0 },
                                        {-width_Perimeter_trans_down/2.0, tickness/2.0 },
                                        { width_Perimeter_trans_down/2.0, tickness/2.0 },
                                        { width_Perimeter_trans_down/2.0, -tickness/2.0 }
                                    })),
            ...
            var width_Perimeter_trans_down_tagSec = new OpenSees.Materials.Sections.FiberSection3dWrapper(
                width_Perimeter_trans_down_tag,
                repres4,
                new Dictionary<int, OpenSees.Materials.Uniaxials.UniaxialMaterialWrapper>() { { G_Timber_Tag_Trans, G_Timber_Tag_TransMat } },
                gjmat);

            int width_inside_long_tag = 5;//set width_inside_long_tag	5
            var repres5 = new OpenSees.Materials.Sections.Repres.FiberSectionReprWrapper(1,
                new OpenSees.Materials.Sections.Repres.PatchWrapper[]
                {
                                    new OpenSees.Materials.Sections.Repres.QuadPatchWrapper(Long_Shear_Timoshenko_Parallel,5,20,new OpenSees.MatrixWrapper(new double[,]{
                                        {-width_inside_long/2.0, tickness/2.0 },
                                        {width_inside_long/2.0, tickness/2.0 },
                                        { width_inside_long/2.0,-tickness/2.0 },
                                        {-width_inside_long/2.0, -tickness/2.0 }
                                    })),
            ...
            var width_inside_long_tagSec = new OpenSees.Materials.Sections.FiberSection3dWrapper(
                width_inside_long_tag,
                repres5,
                new Dictionary<int, OpenSees.Materials.Uniaxials.UniaxialMaterialWrapper>() { { Long_Shear_Timoshenko_Parallel, Long_Shear_Timoshenko_ParallelMat } },
                gjmat);


            int width_inside_trans_tag = 6;//set width_inside_trans_tag	6
            var repres6 = new OpenSees.Materials.Sections.Repres.FiberSectionReprWrapper(1,
                new OpenSees.Materials.Sections.Repres.PatchWrapper[]
                {
                                    new OpenSees.Materials.Sections.Repres.QuadPatchWrapper(Long_Shear_Timoshenko_Serial,5,20,new OpenSees.MatrixWrapper(new double[,]{
                                        {-width_inside_trans_Rec/2.0, -tickness/2.0 },
                                        {-width_inside_trans_Rec/2.0, tickness/2.0 },
                                        { width_inside_trans_Rec/2.0,tickness/2.0 },
                                        {width_inside_trans_Rec/2.0, -tickness/2.0 }
                                    })),
            ...
            var width_inside_trans_tagSec = new OpenSees.Materials.Sections.FiberSection3dWrapper(
                width_inside_trans_tag,
                repres6,
                new Dictionary<int, OpenSees.Materials.Uniaxials.UniaxialMaterialWrapper>() { { Long_Shear_Timoshenko_Serial, Long_Shear_Timoshenko_SerialMat } },
                gjmat);
            ...
            var ele1 = new OpenSees.Elements.DispBeamColumn3dWrapper(1, 100, 101, 5, width_Perimeter_long_left_tagSec, new OpenSees.Elements.BeamIntegrations.BeamIntegrationWrapper(OpenSees.Elements.BeamIntegrations.BeamIntegrationType.Lobatto), lineartag_VerticalCrdT);
            ...
            var ele21 = new OpenSees.Elements.DispBeamColumn3dWrapper(21, 201, 202, 5, width_Perimeter_long_right_tagSec, new OpenSees.Elements.BeamIntegrations.BeamIntegrationWrapper(OpenSees.Elements.BeamIntegrations.BeamIntegrationType.Lobatto), lineartag_VerticalCrdT);
            ...
            // iman modi var ele20 = new OpenSees.Elements.ElasticBeam3dWrapper(20, Area_Perimeter_long_right, E_Timber_Long, G_Timber_Long, Torsional_J_Perimeter_long_right, Iy_Perimeter_long_right, Iz_Perimeter_long_right_mod_down, 200, 201, lineartag_VerticalCrdT, 0, 0, 0);

            var ele20 = new OpenSees.Elements.ForceBeamColumn3dWrapper(20, 200, 201, 5, width_Perimeter_long_right_tagSec, new OpenSees.Elements.BeamIntegrations.BeamIntegrationWrapper(OpenSees.Elements.BeamIntegrations.BeamIntegrationType.Lobatto), lineartag_VerticalCrdT);
            ...
            var ele201 = new OpenSees.Elements.DispBeamColumn3dWrapper(201, 10101, 10201, 5, width_Perimeter_trans_up_tagSec, new OpenSees.Elements.BeamIntegrations.BeamIntegrationWrapper(OpenSees.Elements.BeamIntegrations.BeamIntegrationType.Lobatto), lineartag_VerticalCrdT);
            ...
            // iman modi var ele200 = new OpenSees.Elements.ElasticBeam3dWrapper(200, Area_Perimeter_long_left, E_Timber_Long, G_Timber_Long, Torsional_J_Perimeter_long_left, Iy_Perimeter_long_left, Iz_Perimeter_long_left_mod_down, 10001, 10101, lineartag_VerticalCrdT, 0, 0, 0);

            var ele200 = new OpenSees.Elements.ForceBeamColumn3dWrapper(200, 10001, 10101, 5, width_Perimeter_trans_up_tagSec, new OpenSees.Elements.BeamIntegrations.BeamIntegrationWrapper(OpenSees.Elements.BeamIntegrations.BeamIntegrationType.Lobatto), lineartag_VerticalCrdT);
            ...
            var ele40 = new OpenSees.Elements.DispBeamColumn3dWrapper(40, 301, 302, 5, width_Perimeter_trans_down_tagSec, new OpenSees.Elements.BeamIntegrations.BeamIntegrationWrapper(OpenSees.Elements.BeamIntegrations.BeamIntegrationType.Lobatto), lineartag_HorizontalCrdT);
            ...
            //iman modi var ele39 = new OpenSees.Elements.ElasticBeam3dWrapper(39, Area_Perimeter_trans_down, E_Timber_Trans, G_Timber_Trans, Torsional_J_Perimeter_trans_down, Iy_Perimeter_trans_down, Iz_Perimeter_trans_down_mod, 200, 301, lineartag_HorizontalCrdT, 0, 0, 0);
            var ele39 = new OpenSees.Elements.ForceBeamColumn3dWrapper(39, 200, 301, 5, width_Perimeter_trans_down_tagSec, new OpenSees.Elements.BeamIntegrations.BeamIntegrationWrapper(OpenSees.Elements.BeamIntegrations.BeamIntegrationType.Lobatto), lineartag_HorizontalCrdT);
            ...
            var ele251 = new OpenSees.Elements.DispBeamColumn3dWrapper(251, 30101, 30201, 5, width_inside_long_tagSec, new OpenSees.Elements.BeamIntegrations.BeamIntegrationWrapper(OpenSees.Elements.BeamIntegrations.BeamIntegrationType.Lobatto), lineartag_HorizontalCrdT);
            ...
            var ele250 = new OpenSees.Elements.ForceBeamColumn3dWrapper(250, 20001, 30101, 5, width_inside_long_tagSec, new OpenSees.Elements.BeamIntegrations.BeamIntegrationWrapper(OpenSees.Elements.BeamIntegrations.BeamIntegrationType.Lobatto), lineartag_HorizontalCrdT);
            ...
            var ele72 = new OpenSees.Elements.DispBeamColumn3dWrapper(72, 310, 408, 5, width_inside_trans_tagSec, new OpenSees.Elements.BeamIntegrations.BeamIntegrationWrapper(OpenSees.Elements.BeamIntegrations.BeamIntegrationType.Lobatto), lineartag_VerticalCrdT);
            ...
            var ele71 = new OpenSees.Elements.ForceBeamColumn3dWrapper(71, 315, 415, 5, width_inside_trans_tagSec, new OpenSees.Elements.BeamIntegrations.BeamIntegrationWrapper(OpenSees.Elements.BeamIntegrations.BeamIntegrationType.Lobatto), lineartag_VerticalCrdT);
            ...
            #region recorders
            var savepath = System.Environment.CurrentDirectory + @"\opsnet_results-exp6-fbc\Displacements\";
