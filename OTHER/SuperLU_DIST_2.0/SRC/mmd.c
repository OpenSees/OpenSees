...
/* Subroutine */ static int mmdint_(int *neqns, int *xadj, shortint *adjncy, 
...
/* Subroutine */ static int mmdelm_(int *mdnode, int *xadj, shortint *adjncy,
	 shortint *dhead, shortint *dforw, shortint *dbakw, shortint *qsize, 
...
/* Subroutine */ static int mmdupd_(int *ehead, int *neqns, int *xadj, 
...
/* Subroutine */ static int mmdnum_(int *neqns, shortint *perm, shortint *invp,
				    shortint *qsize)
{
    /* System generated locals */
    int i__1;
