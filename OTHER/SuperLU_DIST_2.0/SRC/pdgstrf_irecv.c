 ...
 * Internal prototypes
 */
static void pdgstrf2(superlu_options_t_Distributed *, int_t, double, Glu_persist_t *,
 ...
 */
{
    ...
    *info = 0;
	...
	i = Llu->bufmax[1];
	if ( !(Llu->Lval_buf_2[0] = doubleMalloc_dist(2 * i)) )
    ...
    if ( !(tempv2d = doubleCalloc_dist(2*ldt*ldt)) )
