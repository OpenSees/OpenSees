...
void check_perm_dist(char *, int_t, int_t *);

void
sp_colorder(superlu_options_t_Distributed *options,  SuperMatrix *A, int_t *perm_c, 
 ...
 * =========
 *
 * options (input) super_lu_options_t_Distributed*
